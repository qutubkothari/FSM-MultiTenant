...
const resources = {
  en: {
    translation: {
      ...
      "followUpToday": "Today",
      "followUpNext7Days": "Next 7 Days",
      "followUpNext30Days": "Next 30 Days",
      "address": "Address",
  ...
  ar: {
    translation: {
      ...
      "clientEmail": "بريد العميل الإلكتروني (اختياري)",
      "openMeetings": "الاجتماعات المفتوحة",
      "followUpDate": "تاريخ المتابعة",
      "followUpFilter": "تصفية المتابعة",
      "followUpAll": "الكل",
      "followUpOverdue": "متأخر",
      "followUpToday": "اليوم",
      "followUpNext7Days": "الأيام السبعة القادمة",
      "followUpNext30Days": "الأيام الثلاثون القادمة",
      "address": "العنوان",
