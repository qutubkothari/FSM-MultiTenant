...
async function sendHyliteAdminSummaries() {
  try {
    ...
    console.log('─'.repeat(50));
    console.log('\n📤 Sending Dec 16 summary...\n');
    
    await sendWhatsAppMessage(adminPhone, message1);
    console.log('✅ Dec 16 summary sent!\n');
    ...
    console.log('─'.repeat(50));
    console.log('\n📤 Sending Dec 17 summary...\n');
    
    await sendWhatsAppMessage(adminPhone, message2);
    console.log('✅ Dec 17 summary sent!\n');
    
    console.log('🎉 Both admin summaries sent successfully!');
    process.exit(0);
  } catch (error) {
